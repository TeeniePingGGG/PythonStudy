'''
반복문: 파이썬에서의 반복문은 while문과 for문만 있습니다
형식] 
  초기값
  while 조건문:
    수행할 문장
...
'''
시나리오] 열번 찍어 안넘어가는 나무 없다라는 속담을 while문으로 구현
'''
treeHit = 0 
while treeHit <10:
  treeHit = treeHit+1
...
while True:
  ...
  # 판매완료 조건이 되었을떄 break를 통해 while문 탈출
  if coffee ==0:
...
'''
시나리오] 로또 번호를 생성하는 프로그램 작성. 1~46 사이에서
